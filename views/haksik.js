document.addEventListener('DOMContentLoaded', function () {
    ...
    async function loadPosts() {
        try {
            const response = await fetch('/haksik/posts'); // API 호출
            const data = await response.json();
            posts = data.map(post => ({
